"use strict";
$(function() {
    const thingpediaUrl = document.body.dataset.thingpediaUrl;
    ...
    function handleOnlineAccountFactory(json, kind, name) {
        ...
        case 'form':
            var form = $('<form>');
            form.attr('action', "/admin/devices/create");
        ...
        case 'link':
            ...
            break;
        case 'oauth2':
            btn.attr('href', '/admin/devices/oauth2/' + kind);
            break;
        default: // discovery or builtin, ignore
            break;
        }
    ...
    function handleOnlineLike(selector, klass) {
        var url = thingpediaUrl + '/thingpedia/api/devices?class=' + klass + '&developer_key='
            + developerKey;
    ...
    $('#device-kind').each(function() {
        ...
        var url = thingpediaUrl + '/thingpedia/api/devices?class=physical&developer_key='
            + developerKey;
        $.get(url, function(factoryList) {
